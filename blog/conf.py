...
BLOG_AUTHOR = "TiebrakerAI"  # (translatable)
BLOG_TITLE = "The Tiebreaker"  # (translatable)
...
BLOG_EMAIL = "tiebreaker@jogatina.info"
BLOG_DESCRIPTION = "Opinions on what makes a game special"  # (translatable)
